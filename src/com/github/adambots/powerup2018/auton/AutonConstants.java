...
public class AutonConstants {
	...
	public static final double SWITCH_STRAIGHT_END_TIME = 1.0;//2.2
	...
	public static final double SCALE_BACK_TIME = 1;
	public static final double SCALE_BACK_SPEED = -0.2;
